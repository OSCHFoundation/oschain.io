! function(t, i) {
    function n(n, o) {
        ...
        var e = t(n),
            ...
            a = {
                star: {
                    color: "rgba(110, 81, 159, .8)",
                    width: 1
                },
                line: {
                    color: "rgba(176, 30, 35, .7)",
                    width: .2
                },
                position: {
                    x: 0,
        ...
        //console.log(console.log(t.fn));
        console.log(t.fn.constellation);
    t.fn.constellation = function(t) {
        console.log(t);
        t.line.color = "rgba(246, 246, 246, .8)"
        t.star.color = "rgba(246, 246, 246, .8)";
